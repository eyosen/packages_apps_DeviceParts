...
public class SweepToSleepSwitch implements OnPreferenceChangeListener {

    public static final String SETTINGS_KEY = DeviceSettings.KEY_SETTINGS_PREFIX + DeviceSettings.KEY_S2S_SWITCH;

    private Context mContext;

    public SweepToSleepSwitch(Context context) {
        mContext = context;
    }

    public static String getFile(Context context) {
        String fileName = context.getResources().getString(R.string.pathSweepToSleepToggle);
